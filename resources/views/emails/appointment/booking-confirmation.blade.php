...
<div style="font-family:'Urbanist','Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:28px;color:#3d2e22;margin-bottom:28px;">
    ...
    Your session with <strong style="color:#4b3425;">{{ $therapistName }}</strong> is confirmed. We're glad you're making time for yourself — it matters.
</div>
        ...
        <td style="padding:20px 24px;background-color:#f7f4f2;">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td style="font-family:'Urbanist','Helvetica Neue',Arial,sans-serif;font-size:14px;font-weight:700;color:#4b3425;padding-bottom:10px;">{{ $dateTime }}</td>
                </tr>
            </table>
        </td>
    </tr>
...
<div style="font-family:'Urbanist','Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;color:#926247;margin-bottom:28px;">
    Please join 5 minutes early and find a quiet space where you feel comfortable and uninterrupted.
</div>
